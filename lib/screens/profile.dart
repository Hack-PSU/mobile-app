                  ...
                  child: Column (
                    ...
                    children: [
                      Container(
                        ...
                        margin: const EdgeInsets.only(top: 25.0, right: 5, left: 30),
                        child:  _EmailGetter(),
                      ),
                      Container(
            ...
            Padding(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  primary: const Color(0xFF113654)
                ),
                  onPressed: () => context.read<ProfileCubit>().changePassword(oldPassword.text, newPassword.text),
                  child: DefaultText(
                    'Submit',
